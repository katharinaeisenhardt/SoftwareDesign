...
namespace FinaleAbgabe
{
    public class GameData
    {
        ...
        public static void CreateCharacters()
        {
            ...
            (
            "Golem", 0.6F, 0.15F, "GRRRRR!", rooms["Dark Rabbit Hole"]
            );

            Enemy DeathKing = new Enemy
            (
            "King of death", 1F, 0.3F, "GRRRR! I'm the King of death! Weak as ever, you might as well just die!", rooms["Haunted Valley of Death"]
            );

            Helper Dragon = new Helper
            (
            "Dragon of the sea", 1F, 1F, "I'm the Dragon of the sea!", rooms["Sacred Sea"]
            );
